    ...
    <div className="grid grid-cols-2 gap-8 mt-6 mb-16 lg:grid-cols-4 lg:gap-5">
        ...
        <div className="flex items-center gap-6"> 
            ...
            <div className="space-y-1">
                ...
                <p className="text sm">Todos Nuestros Productos puedes ser Devueltos dentro de 72 horas.</p>
            </div>
        </div>
        ...
        <div className="flex items-center gap-6"> 
            ...
            <div className="space-y-1">
                ...
                <p className="text sm">Garantia de 1 años en todos nuestros productos.</p>
            </div>
        </div>
    </div>
  )
